...
export default function ReportModal({
  ...
  const renderReasonStep = () => (
    <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
      ...
      {alreadyReported ? (
        <View className="bg-skillset-bg-input rounded-xl p-4 mb-4">
        ...
        <View className="space-y-2">
          {REPORT_REASONS.map((reason) => (
            <Pressable
              ...
              className="bg-skillset-bg-card rounded-xl p-4 flex-row items-center justify-between active:bg-skillset-bg-input mb-2"
            >
        ...
        <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          ...
          <View className="flex-row space-x-3">
            <Pressable
              ...
              className="flex-1 bg-skillset-bg-card py-4 rounded-xl mr-2"
            >
  ...
  const renderSuccessStep = () => (
    <View className="flex-1 items-center justify-center">
      ...
      <Text className="text-slate-400 text-center mb-8 px-4">
        Thank you for helping keep Skillset safe. Our team will review your report
  ...
  return (
    ...
    >
      <View className="flex-1 bg-skillset-bg-dark">
        {/* Header */}
        <View className="flex-row items-center justify-between px-4 py-4 border-b border-skillset-border">
          <View className="w-10" />
          <Text className="text-white text-lg font-semibold">
