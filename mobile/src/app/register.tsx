            ...
            <View className="flex-1 justify-center px-6">
              ...
              <View className="space-y-4">
                <Pressable
                  ...
                  className="bg-workly-bg-input/70 rounded-2xl p-6 border border-workly-border active:scale-[0.98]"
                >
                ...
                <Pressable
                  ...
                  className="bg-workly-bg-input/70 rounded-2xl p-6 border border-workly-border active:scale-[0.98] mt-4"
                >
                  <View className="flex-row items-center">
